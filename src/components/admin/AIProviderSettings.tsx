...
const PROVIDERS: ProviderOption[] = [
  {
    ...
    models: [
      { value: "gpt-5", label: "GPT-5", hint: "Latest flagship - best reasoning & tool use" },
      { value: "gpt-5-mini", label: "GPT-5 Mini", hint: "Balanced performance & cost" },
      { value: "gpt-5-nano", label: "GPT-5 Nano", hint: "Fastest & cheapest" },
      { value: "gpt-5.2", label: "GPT-5.2", hint: "Enhanced reasoning" },
      { value: "gpt-4o", label: "GPT-4o", hint: "Reasoning + vision" },
  ...
  },
  {
    ...
    models: [
      { value: "openai/gpt-5", label: "GPT-5 (via gateway)", hint: "Best reasoning & tool use" },
      ...
      { value: "google/gemini-3-flash-preview", label: "Gemini 3 Flash (Preview)", hint: "Recommended default" },
