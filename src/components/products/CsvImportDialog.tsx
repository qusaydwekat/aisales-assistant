      ...
      >
        ...
        >
          <div className="p-4 md:p-6 border-b border-border/50 flex items-center justify-between">
            <div>
              <h2 className="text-lg font-heading font-bold text-foreground">Import products from CSV</h2>
              <p className="text-xs text-muted-foreground mt-0.5">Bulk add many products at once</p>
            </div>
              ...
              <>
                ...
                <label className="block">
                  <div className="border-2 border-dashed border-border hover:border-primary/50 rounded-xl p-8 text-center cursor-pointer transition-colors">
                    ...
                    <p className="text-sm text-foreground mt-2 font-medium">Click to upload CSV</p>
                    <p className="text-xs text-muted-foreground mt-1">
                      Headers: name, description, category, price, compare_price, stock, sku, active, image_url
                    </p>
                  </div>
                  <input
                    type="file"
                  ...
                  <table className="w-full text-xs">
                    <thead className="bg-muted/50 sticky top-0">
                      <tr>
                        ...
                        <th className="px-2 py-2 text-start font-medium text-muted-foreground">Category</th>
                        <th className="px-2 py-2 text-start font-medium text-muted-foreground">Price</th>
                        <th className="px-2 py-2 text-start font-medium text-muted-foreground">Stock</th>
